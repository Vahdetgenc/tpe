...
import de.hsmannheim.informatik.ib2.tpe.uebung2.aufgabe2.m1329483_m1323010.util.InsertionSort;
...
import de.hsmannheim.informatik.ib2.tpe.uebung2.aufgabe2.m1329483_m1323010.util.ShakerSort;
import de.hsmannheim.informatik.ib2.tpe.uebung2.aufgabe2.m1329483_m1323010.util.ISortMethod;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Print.print("Initialize random and test");
		initialize();
		Print.print("ShakerSort: ");
		sortArray(new ShakerSort(), myIntArray);
		sortArray(new ShakerSort(), myStringArray);
		
		initialize();
		Print.print("InsertionSort: ");
		sortArray(new InsertionSort(), myIntArray);
		sortArray(new InsertionSort(), myStringArray);
//		
//		
...
//		Sort.sortArray(false, myStringArray);
	...
	public static void sortArray(ISortMethod kindOfSort, IComparable[] ArrayToSort) {
		Print.print("Before sort: ");
		Print.printArray(ArrayToSort);
		kindOfSort.sort(ArrayToSort);
